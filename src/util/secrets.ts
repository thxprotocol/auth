...
if (process.env.NODE_ENV === 'test') {
    if (process.env.AUTH_URL_TEST_OVERRIDE !== undefined) {
        process.env.AUTH_URL = process.env.AUTH_URL_TEST_OVERRIDE;
        process.env.ISSUER = process.env.AUTH_URL_TEST_OVERRIDE;
    }
